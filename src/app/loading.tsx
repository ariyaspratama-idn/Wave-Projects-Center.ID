...
export default function Loading() {
    return (
        <div className="fixed inset-0 z-[100] bg-surface flex flex-col items-center justify-center -mt-20">
            ...
            <div className="relative w-32 h-32 md:w-48 md:h-48 animate-pulse-slow z-10 flex items-center justify-center mb-8">
                <Image src={Logo} alt="Memuat Wave Projects" priority className="object-contain w-full h-full drop-shadow-[0_0_20px_rgba(45,91,255,0.3)]" />
            </div>
