...
export async function POST(req: Request) {
    try {
        ...
        const response = await fetch(`https://generativelanguage.googleapis.com/v1beta/models/gemini-1.5-flash-latest:streamGenerateContent?alt=sse&key=${GEMINI_API_KEY}`, {
            method: 'POST',
            headers: {
