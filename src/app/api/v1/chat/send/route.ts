...
export async function POST(req: Request) {
    try {
        ...
        try {
            ...
            5. GAYA BAHASA & FORMAT: Natural, ramah, meyakinkan, terstruktur, tidak bertele-tele, dan selalu profesional. DILARANG KERAS menggunakan format markdown seperti bintang ganda (**) untuk menebalkan teks karena sistem chat tidak akan merendernya. DILARANG menyebut istilah internal teknis "PRD" (Product Requirements Document) atau "Dokumen Rekayasa Perangkat Lunak" kepada Klien. Gunakan istilah ramah seperti "Detail Sistem" atau "Kebutuhan Berkas".
