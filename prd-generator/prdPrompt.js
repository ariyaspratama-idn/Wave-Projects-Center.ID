...
3. Arsitektur Terarah (Opinionated): Jika tidak ada instruksi khusus, asumsikan filosofi "Self-Hosted First" (Docker, Proxmox, MinIO, PostgreSQL di server lokal) sebagai standar Wave Projects, atau ikuti preferensi dari raw input.
4. Terstruktur per Epic/Flow: Fitur dijabarkan dengan langkah yang konkret (Business Logic & Validation Rules).
5. Cross-Functional: Selain untuk developer, output juga akan dibaca oleh Admin Keuangan (budgeting estimasi), Admin CS (ekspektasi), dan Owner.
